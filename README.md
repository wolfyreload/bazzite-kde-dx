# Wolfy-kde-dx Custom Image

This is my own custom Universal Blue image, that is based off of the bazzite-nvidia:testing image. I have customised the <https://github.com/ublue-os/image-template> template to build this image.
...
```bash
rpm-ostree rebase ostree-unverified-registry:ghcr.io/wolfyreload/bazzite-kde-wolfy:latest
```
